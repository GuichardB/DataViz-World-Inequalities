...
#Evolution de la part du revenu national des 10% les plus riches, de 1980 à 2019PTNIT10dataset %>% 
ggplot(PTNIT10dataset)+geom_line(aes(x=Year, y=WesternEuropePTNIT10, group=1))
```
